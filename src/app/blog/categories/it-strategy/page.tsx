...
export default async function CategoryPage() {
  const posts = await getPostsByCategory("IT & Digital Strategy");
  const color = "#06B6D4";
  return (
    <>
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold tracking-tight mb-4">
            IT & Digital Strategy <span className="text-gradient">Articles</span>
          </h1>
          <p className="text-lg text-white/50 max-w-2xl mx-auto">Digital strategy guides for Canadian small businesses — cloud costs, software decisions, cybersecurity basics, and IT planning.</p>
        </div>
      </section>
