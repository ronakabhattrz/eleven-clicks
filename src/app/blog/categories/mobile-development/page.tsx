...
export default async function CategoryPage() {
  const posts = await getPostsByCategory("Mobile Development");
  const color = "#8B5CF6";
  return (
    <>
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold tracking-tight mb-4">
            Mobile Development <span className="text-gradient">Articles</span>
          </h1>
          <p className="text-lg text-white/50 max-w-2xl mx-auto">Mobile app guides for Canadian businesses — iOS vs Android, costs, timelines, and what to expect from app development.</p>
        </div>
      </section>
