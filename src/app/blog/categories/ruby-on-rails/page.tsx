...
export default async function CategoryPage() {
  const posts = await getPostsByCategory("Ruby on Rails");
  const color = "#E53E3E";
  return (
    <>
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold tracking-tight mb-4">
            Ruby on Rails <span className="text-gradient">Articles</span>
          </h1>
          <p className="text-lg text-white/50 max-w-2xl mx-auto">Ruby on Rails guides for Canadian businesses and developers — when to use Rails, what it costs, and how it compares to other frameworks.</p>
        </div>
      </section>
